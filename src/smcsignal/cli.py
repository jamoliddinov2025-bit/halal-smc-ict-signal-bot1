...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(
        prog="smcsignal",
        description=(
            "Professional Halal SMC/ICT Spot Signal Bot — Phase 21 walk-forward "
    ...
    print("Phase 21: deterministic walk-forward robustness validation over the unchanged pipeline.")
